...
ระบบเป็น Web Application ภายในองค์กรสำหรับบันทึก ติดตาม และรายงานงานของทีม IT และ AV ภายในองค์กร ใช้ PHP แบบ Server-rendered ร่วมกับ MySQL/MariaDB และเพิ่มพฤติกรรมหน้าจอด้วย JavaScript
...
- สถานที่:
  - ดึงจากตาราง `task_locations` (ตัวอย่าง: ห้องประชุม A, ห้องประชุม B, ล็อบบี้ ฯลฯ) — ปรับแต่งได้ในหน้า System Config
  - อื่นๆ
