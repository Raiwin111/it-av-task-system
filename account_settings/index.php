            ...
            <form class="card-body p-4" method="post" enctype="multipart/form-data">
                ...
                <div class="row g-4 align-items-stretch">
                    <div class="col-lg-3 d-flex flex-column align-items-center justify-content-center text-center py-3">
                        <div class="profile-avatar rounded-circle d-inline-flex align-items-center justify-content-center overflow-hidden mb-3" style="width:112px;height:112px;font-size:2.4rem;">
                            <?php if (!empty($account_profile["profile_image"])): ?><img src="../<?php echo htmlspecialchars($account_profile["profile_image"], ENT_QUOTES, "UTF-8"); ?>" alt="รูปโปรไฟล์" class="w-100 h-100 object-fit-cover"><?php else: ?><i class="bi bi-person-fill"></i><?php endif; ?>
                        </div>
                        ...
                        <div class="form-text mt-2" id="accountProfileFileName">JPG, PNG หรือ WebP ไม่เกิน 2 MB</div>
                    </div>
                    <div class="col-lg-5"><div class="d-grid gap-3">
                        ...
                        <div><label class="form-label" for="accountFullName">ชื่อ-นามสกุล</label><input class="form-control" id="accountFullName" name="full_name" maxlength="120" value="<?php echo htmlspecialchars($account_profile["full_name"] ?? "", ENT_QUOTES, "UTF-8"); ?>"></div>
...
(() => {
    ...
    profileImageInput?.addEventListener('change', () => {
        ...
        if (profileFileName) profileFileName.textContent = file ? file.name : 'JPG, PNG หรือ WebP ไม่เกิน 2 MB';
    });
