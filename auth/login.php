        ...
        <div class="login-wrapper">
            ...
            <div class="card-body p-4 p-md-5">
                <div class="text-center mb-4">
                    <div class="brand-icon rounded-circle d-inline-flex align-items-center justify-content-center mb-3"><img src="login-icon.png" alt="ไอคอนระบบ IT / AV Task Management System" width="44" height="44"></div>
                    <h1 class="system-title h4 fw-bold mb-1">IT / AV Task Management System</h1>
                    <p class="system-subtitle mb-0">เข้าสู่ระบบเพื่อใช้งาน</p>
                </div>
            ...
            <footer class="page-footer text-center mt-4">
                ...
                <div>Aurora Grand Hotel (Demo)</div>
            </footer>
        </div>
    </main>
    <script>
