...
<head>
    ...
    <style>
        ...
        .brand-mark { width: 46px; height: 46px; color: #fff; background: linear-gradient(135deg, #237bd1, #103d6d); box-shadow: 0 5px 13px rgba(25, 112, 197, .28); }.brand-mark i { font-size: 1.25rem; }.brand-title { color: #f8fafc; font-size: 1.22rem; letter-spacing: -.01em; }
        .profile-avatar { width: 50px; height: 50px; color: #fff; background: #1e3a5f; box-shadow: 0 0 0 2px rgba(255, 255, 255, .18); }.profile-avatar > i { font-size: 1.35rem; }.user-detail { line-height: 1.2; }.profile-username { color: #f8fafc; font-size: 1.05rem; }.role-badge { display: inline-block; margin-top: .25rem; padding: .22rem .58rem; color: #fff; border-radius: 999px; background: #134e4a; font-size: .8rem; font-weight: 700; letter-spacing: .02em; text-transform: uppercase; }
        ...
        .brand-title { color: #fff; }.sidebar { background: linear-gradient(180deg, #111827, #0b1220); box-shadow: 4px 0 18px rgba(2, 6, 23, .24); }
