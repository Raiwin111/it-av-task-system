...
$standard_equipment_definitions = [
    ...
    ["display_name" => "ระบบเสียงหลักขององค์กร", "master_names" => ["ระบบเสียงหลักขององค์กร"]],
];
...
<div class="app-shell d-flex">
    ...
    <main class="main-content task-input-page flex-grow-1 p-4 p-lg-5">
        ...
        <div class="alert alert-light border d-flex align-items-start gap-2 mb-4" role="note">
            ...
            <div class="small text-muted">รายละเอียดงาน การดำเนินงาน ปัญหา วิธีแก้ไข ประเภทปัญหา และรูปภาพประกอบ สามารถเพิ่มหรือแก้ไขภายหลังได้จากหน้า <strong>Report</strong> → ปุ่ม <strong>แก้ไข</strong> ในแต่ละรายการ</div>
        </div>
